...
train_img_dir = r'C:\Users\kevin\Desktop\NEU_Cloud\202209_Fall_Semester\01_Deep_Learning\04_Project\01_NIC\cocoapi\images\train2017'
...
if __name__ == '__main__':
    ...
    for epoch in range(1, num_of_epochs + 1):
        ...
        for img_batch, captions in train_loader:
            ...
            probs = decoder(enc_feats, captions)
        ...
        torch.save(decoder.state_dict(),
                   join(model_dir, 'decoder-{}.pkl'.format(epoch)))
        torch.save(encoder.state_dict(),
                   join(model_dir, 'encoder-{}.pkl'.format(epoch)))
